//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 
// Constants
const API_KEY = "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";
...
function onOpen() {
  ...
  function generatePrompt() {
    ...
    const selectedText = presentation.getSelection().getCurrentPage().getShapes()[0].getText().asString();
    const slide = presentation.getSelection().getCurrentPage();
    const prompt ="Generate 10 points on "+ selectedText;
    const temperature = 0;
    const maxTokens = 2060;
